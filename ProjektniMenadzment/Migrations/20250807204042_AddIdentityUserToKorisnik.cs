...
{
    /// <inheritdoc />
    public partial class AddIdentityUserToKorisnik : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Korisnici_IdentityUser_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZanrId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DatumKreiranja = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Korisnici_IdentityUserId",
                table: "Korisnici",
